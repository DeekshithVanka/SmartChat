...
const ChatContainer = () => {
  ...
  const shouldShowMessage = (message) => {
    if (!message.isScheduled) return true;
    if (message.senderId === authUser._id) return true;
  ...
  return (
    <div className="flex-1 flex flex-col overflow-auto">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message, idx) => shouldShowMessage(message) && (
          <div
            key={message._id}
          ...
          >
            ...
            <div className="chat-header mb-1 flex items-center gap-2">
              ...
              {message.isScheduled && message.senderId === authUser._id && (
            ...
            <div className={`chat-bubble ${message.senderId === authUser._id ? "chat-bubble-primary" : "chat-bubble-secondary"}`}>
              ...
              {message.text && <p className="text-base-100">{message.text}</p>}
            </div>
            {message.isRead && message.senderId === authUser._id && (
